...
export interface PostV1AuthLoginSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Login Successful","data":{"accessToken":"access token","refreshToken":"refresh token","user":{"_id":"65f2024bbd19b118fa8a4a6e","email":"example@xyz.abc","emailVerified":false,"role":"user","method":"email"}}} */
  data: {
    message: string;
    data: {
      accessToken: string;
...
export interface PostV1IngredientsAddSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Ingredient Added Successfully","data":{"_id":"65f20256bd19b118fa8a4a87","name":"abc","category":"abc","unit":{"quantity":123,"unit":"cup"},"micronutrient":[{"quantity":123,"unit":"cup","name":"fat"}],"createdAt":"2021-09-25T06:30:00.000Z","updatedAt":"2021-09-25T06:30:00.000Z"}} */
  data: {
    message: string;
    data: {
      /** @format any */
...
export interface GetV1IngredientsGetSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Ingredient Added Successfully","meta":{"total":1,"page":1,"limit":10,"totalPages":1},"data":[{"_id":"65f20256bd19b118fa8a4a89","name":"abc","category":"abc","unit":{"quantity":123,"unit":"cup"},"micronutrient":[{"quantity":123,"unit":"cup","name":"fat"}],"createdAt":"2021-09-25T06:30:00.000Z","updatedAt":"2021-09-25T06:30:00.000Z"}]} */
  data: {
    message: string;
    meta: {
      /**
...
export interface GetV1IngredientsGetIdSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Ingredient Added Successfully","data":{"_id":"65f20256bd19b118fa8a4a8b","name":"abc","category":"abc","unit":{"quantity":123,"unit":"cup"},"micronutrient":[{"quantity":123,"unit":"cup","name":"fat"}],"createdAt":"2021-09-25T06:30:00.000Z","updatedAt":"2021-09-25T06:30:00.000Z"}} */
  data: {
    message: string;
    data: {
      /** @format any */
...
export type GetV1ProfileGetWeightsParameterWeek = string;

export type GetV1ProfileGetWeightsParameterMonth = string;

export type GetV1ProfileGetWeightsParameterYear = string;

export interface GetV1ProfileGetWeightsSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Profile Updated","data":[{"weight":"70","week":"1","month":"January","year":"2021"}]} */
  data: {
    message: string;
    data: {
      weight: string;
...
export interface GetV1ProfileGetWeightsErrorResponse {
  status: 'error';
  error: {
    message: string;
  };
...
export interface GetV1ProgramGetSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Data fetched Successfully","meta":{"total":1,"page":1,"limit":10,"totalPages":1},"data":[{"_id":"65f20256bd19b118fa8a4a97","name":"abc","assignedUsers":[{"_id":"65f20256bd19b118fa8a4a98","email":"abc","createdAt":"2024-03-13T19:45:26.834Z","updatedAt":"2024-03-13T19:45:26.834Z","profile":{"avatar":"abc","fullName":"abc"}}],"createdAt":"2024-03-13T19:45:26.834Z","updatedAt":"2024-03-13T19:45:26.834Z","startingDate":"2024-03-13T19:45:26.834Z","endingDate":"2024-03-13T19:45:26.834Z"}]} */
  data: {
    message: string;
    meta: {
      /**
...
export interface GetV1ProgramGetIdSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Data fetched Successfully","data":{"_id":"65f20256bd19b118fa8a4a9a","name":"abc","assignedUsers":[{"_id":"65f20256bd19b118fa8a4a9b","email":"abc","createdAt":"2024-03-13T19:45:26.838Z","updatedAt":"2024-03-13T19:45:26.838Z","profile":{"avatar":"abc","fullName":"abc"}}],"createdAt":"2024-03-13T19:45:26.838Z","updatedAt":"2024-03-13T19:45:26.838Z","startingDate":"2024-03-13T19:45:26.838Z","endingDate":"2024-03-13T19:45:26.838Z"}} */
  data: {
    message: string;
    data: {
      /** @format any */
...
export interface GetV1ProgramUserSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Data fetched Successfully","data":[{"_id":"abc","day":1,"week":1,"date":"2024-03-13T19:45:26.850Z","assignedTo":"abc","programId":{"_id":"65f20256bd19b118fa8a4a9c","name":"abc","startingDate":"2024-03-13T19:45:26.850Z","endingDate":"2024-03-13T19:45:26.850Z","assignedUsers":[],"createdAt":"2024-03-13T19:45:26.850Z","updatedAt":"2024-03-13T19:45:26.850Z"},"isCompleted":false,"workouts":[{"_id":"65f20256bd19b118fa8a4a9d","exerciseId":"65f20256bd19b118fa8a4a9e","programId":"65f20256bd19b118fa8a4a9f","createdAt":"2024-03-13T19:45:26.850Z","updatedAt":"2024-03-13T19:45:26.850Z","sets":[{"reps":1,"weight":1,"rest":1,"time":1}],"circuit":"circuit","warmup":"warmup","createdBy":"65f20256bd19b118fa8a4aa0","notes":["notes"],"type":"circuit"}],"createdAt":"2024-03-13T19:45:26.850Z","updatedAt":"2024-03-13T19:45:26.850Z"}]} */
  data: {
    message: string;
    data: {
      _id?: string;
...
export interface GetV1WorkoutGetSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Data fetched Successfully","meta":{"total":1,"page":1,"limit":10,"totalPages":1},"data":[{"_id":"65f20257bd19b118fa8a4ac1","createdBy":"65f20257bd19b118fa8a4ac2","exerciseId":"65f20257bd19b118fa8a4ac3","programId":"65f20257bd19b118fa8a4ac4","notes":["notes"],"sets":[{"reps":1,"weight":1,"rest":1,"time":1,"_id":"65f20257bd19b118fa8a4ac5","createdAt":"2024-03-13T19:45:27.199Z","updatedAt":"2024-03-13T19:45:27.199Z"}],"createdAt":"2024-03-13T19:45:27.199Z","updatedAt":"2024-03-13T19:45:27.199Z","circuit":"circuit","warmup":"warmup","type":"circuit","dateTime":{"day":1,"week":1,"date":"2024-03-13T19:45:27.199Z"},"isCompleted":false}]} */
  data: {
    message: string;
    meta: {
      /**
...
export interface GetV1WorkoutGetIdSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Data fetched Successfully","data":{"_id":"65f20257bd19b118fa8a4ac7","createdBy":"65f20257bd19b118fa8a4ac8","exerciseId":"65f20257bd19b118fa8a4ac9","programId":"65f20257bd19b118fa8a4aca","notes":["notes"],"sets":[{"reps":1,"weight":1,"rest":1,"time":1,"_id":"65f20257bd19b118fa8a4acb","createdAt":"2024-03-13T19:45:27.203Z","updatedAt":"2024-03-13T19:45:27.203Z"}],"createdAt":"2024-03-13T19:45:27.203Z","updatedAt":"2024-03-13T19:45:27.203Z","circuit":"circuit","warmup":"warmup","type":"circuit","dateTime":{"day":1,"week":1,"date":"2024-03-13T19:45:27.203Z"},"isCompleted":false}} */
  data: {
    message: string;
    data: {
      /** @format any */
...
export interface GetV1WorkoutFilterSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Data fetched Successfully","data":[{"_id":"65f20257bd19b118fa8a4ace","createdBy":"65f20257bd19b118fa8a4acf","exerciseId":"65f20257bd19b118fa8a4ad0","programId":"65f20257bd19b118fa8a4ad1","notes":["notes"],"sets":[{"reps":1,"weight":1,"rest":1,"time":1,"_id":"65f20257bd19b118fa8a4ad2","createdAt":"2024-03-13T19:45:27.222Z","updatedAt":"2024-03-13T19:45:27.222Z"}],"createdAt":"2024-03-13T19:45:27.222Z","updatedAt":"2024-03-13T19:45:27.222Z","circuit":"circuit","warmup":"warmup","type":"circuit","dateTime":{"day":1,"week":1,"date":"2024-03-13T19:45:27.222Z"},"isCompleted":false}]} */
  data: {
    message: string;
    data: {
      /** @format any */
...
export interface PostV1ChatSendMessagesSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Message Sent Successfully","data":{"_id":"65f2024ebd19b118fa8a4a79","text":"text","files":["files"],"createdAt":"2024-03-13T19:45:18.250Z","updatedAt":"2024-03-13T19:45:18.250Z","sender":"65f2024ebd19b118fa8a4a7a"}} */
  data: {
    message: string;
    data: {
      /** @format any */
...
export interface GetV1ChatChatSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Data fetched Successfully","meta":{"total":1,"page":1,"limit":10,"totalPages":1},"data":[{"_id":"65f2024ebd19b118fa8a4a71","user":{"_id":"65f2024ebd19b118fa8a4a72","email":"email","profile":{"_id":"65f2024ebd19b118fa8a4a73","fullName":"fullName","avatar":"avatar"}},"lastMessage":{"_id":"65f2024ebd19b118fa8a4a74","text":"text","files":["files"],"createdAt":"2024-03-13T19:45:18.229Z","updatedAt":"2024-03-13T19:45:18.229Z","sender":"65f2024ebd19b118fa8a4a75"},"createdAt":"2024-03-13T19:45:18.229Z","updatedAt":"2024-03-13T19:45:18.229Z"}]} */
  data: {
    message: string;
    meta: {
      /**
...
export interface GetV1ChatGetIdSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Message Sent Successfully","meta":{"total":1,"page":1,"limit":10,"totalPages":1},"data":[{"_id":"65f2024ebd19b118fa8a4a76","text":"text","files":["files"],"createdAt":"2024-03-13T19:45:18.237Z","updatedAt":"2024-03-13T19:45:18.237Z","sender":"65f2024ebd19b118fa8a4a77"}]} */
  data: {
    message: string;
    meta: {
      /**
...
export interface GetV1ContactDetailsGetSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Data fetched Successfully","data":{"_id":"65f2024ebd19b118fa8a4a7b","phone":"1234567890","email":"example@gmail.com","whatsapp":"https://www.google.com","twitter":"https://www.google.com","createdAt":"2024-03-13T19:45:18.291Z","updatedAt":"2024-03-13T19:45:18.291Z"}} */
  data: {
    message: string;
    data: {
      /** @format any */
...
export interface PostV1NotificationFcmSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Token Added Successfully","data":{"_id":"65f20256bd19b118fa8a4a91","token":"abc","userId":"65f20256bd19b118fa8a4a92","createdAt":"2024-03-13T19:45:26.639Z","updatedAt":"2024-03-13T19:45:26.639Z","type":"web"}} */
  data: {
    message: string;
    data: {
      /** @format any */
...
export interface GetV1NotificationGetSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Ingredient Added Successfully","meta":{"total":1,"page":1,"limit":10,"totalPages":1},"data":[{"_id":"65f20256bd19b118fa8a4a93","title":"title","body":"body","userId":{"_id":"65f20256bd19b118fa8a4a94","email":"email","emailVerified":true,"role":"admin"},"type":"all","image":"image","createdAt":"2024-03-13T19:45:26.648Z","updatedAt":"2024-03-13T19:45:26.648Z"}]} */
  data: {
    message: string;
    meta: {
      /**
...
export interface GetV1CallStartSuccessfulResponse {
  status: 'success';
  /** @example {"message":"Token Generated Successfully","data":{"token":"f55c2c10-4483-4725-9fad-7317cf1c39be","channelName":"0f1f41a2-d3bc-4c77-9e38-1b273e103419","uId":"42000253-52de-404e-9c43-75546b8c4194"}} */
  data: {
    message: string;
    data: {
      token: string;
...
> extends HttpClient<SecurityDataType> {
  v1 = {
     ...
     *
     * @tags User Profile
     * @name GetV1ProfileGetWeights
     * @summary Update Profile endpoint
     * @request GET:/v1/profile/get/weights
     * @secure
     */
    getV1ProfileGetWeights: (
      query?: {
        /** GET /v1/profile/get/weights parameter */
        week?: GetV1ProfileGetWeightsParameterWeek;
        /** GET /v1/profile/get/weights parameter */
        month?: GetV1ProfileGetWeightsParameterMonth;
        /** GET /v1/profile/get/weights parameter */
        year?: GetV1ProfileGetWeightsParameterYear;
      },
      params: RequestParams = {},
    ) =>
      this.request<
        GetV1ProfileGetWeightsSuccessfulResponse,
        GetV1ProfileGetWeightsErrorResponse
      >({
        path: `/v1/profile/get/weights`,
        method: 'GET',
        query: query,
        secure: true,
        format: 'json',
     ...
     * @tags Call
     * @name GetV1CallStart
     * @summary Start Call to User
     * @request GET:/v1/call/start
     * @secure
     */
    getV1CallStart: (
      query: {
        /** GET /v1/call/start parameter */
        to: GetV1CallStartParameterTo;
        /** GET /v1/call/start parameter */
        type: GetV1CallStartParameterType;
      },
      params: RequestParams = {},
    ) =>
      this.request<
     ...
     *
     * @tags Call
     * @name PostV1CallDecline
     * @summary Decline Call Request
